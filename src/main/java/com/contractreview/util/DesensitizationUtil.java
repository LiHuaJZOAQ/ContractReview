...
public class DesensitizationUtil {
    ...
    public static String desensitize(String text) {
        ...
        result = NAME_AFTER_PARTY_2.matcher(result).replaceAll(m -> m.group().replaceAll("[\\u4e00-\\u9fa5]{2,4}$", "***"));
        result = NAME_AFTER_PARTY_3.matcher(result).replaceAll(m -> m.group().replaceAll("[\\u4e00-\\u9fa5]{2,4}$", "***"));
